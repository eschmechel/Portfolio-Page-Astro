...
export const ProjectList: Project[] = [
  {
    ...
    description: "Personal homelab running Proxmox with automated Docker containers, secure remote access via Wireguard subnet routing, and comprehensive monitoring setup.",
    technologiesList: [
      "Proxmox",
      "Docker",
      "Bash",
  ...
  },
  {
    ...
    category: "Website",
    description: "20 Games Challenge is a personal project where I aim to create 20 games in 1 year, showcasing my skills in game development and design.",
    technologiesList: [
      "Godot Engine",
      "Unity",
      "Unreal Engine",
  ...
  },
  {
    ...
    category: "Website",
    description: "Maintaining the Langara French Club website as well as managing its communication and outreach.",
    technologiesList: [
      "EmailJS",
      "React",
      "Swiper",
  ...
  },
  {
    ...
    category: "Outreach",
    description: "Building a community for inter-uni collaboration and support.",
    technologiesList: [
      "Discord",
      "Cloudflare"
    ],
  ...
  },
  {
    ...
    category: "Website",
    description: "A web application to help students schedule their courses effectively.",
    technologiesList: [
      "React",
      "Node.js",
      "Express",
